...
import OperatorSelectionSubscription from './OperatorSelectionSubscription';
import SubscriptionRechargeForm from './SubscriptionRechargeForm';
// ... Your icon imports
const services = [
...
const SubscriptionPage= () => {
  ...
  return (
    <div>
      ...
      <SubscriptionRechargeForm />
      <OperatorSelectionSubscription onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
