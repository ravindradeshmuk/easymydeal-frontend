...
import OperatorSelectionDataCard from './OperatorSelectionDataCard';
import DataCardRechargeForm from './DataCardRechargeForm';
// ... Your icon imports
const services = [
...
const DataCardPage= () => {
  ...
  return (
    <div>
      ...
      <DataCardRechargeForm />
      <OperatorSelectionDataCard onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
