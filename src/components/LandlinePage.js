...
import OperatorSelectionLandline from './OperatorSelectionLandline';
import LandlineRechargeForm from './LandlineRechargeForm';
...
const LandlinePage= () => {
  ...
  return (
    ...
    <LandlineRechargeForm/>
      <OperatorSelectionLandline onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
