...
import MunicipalRechargeForm from './MunicipalRechargeForm';
import OperatorSelectionMunicipal from './OperatorSelectionMunicipal';
// ... Your icon imports
const services = [
...
const MunicipalServicePage= () => {
  ...
  return (
    <div>
      ...
      <MunicipalRechargeForm/>
      <OperatorSelectionMunicipal onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};

export default MunicipalServicePage;
