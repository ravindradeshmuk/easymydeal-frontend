...
import InsurancePaymentForm from './InsurancePaymentForm.js';
 import OperatorSelectionInsurance from './OperatorSelectionInsurance.js';
// ... Your icon imports
const services = [
...
const RechargeBillPay= () => {
  ...
  return (
    ...
    <InsurancePaymentForm />
      <OperatorSelectionInsurance onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
