...
import FasTagPaymentForm from './FasTagPaymentForm.js';
import OperatorSelectionFasTag from './OperatorSelectionFasTag.js';
// ... Your icon imports
const services = [
...
const RechargeBillPay= () => {
  ...
  return (
    ...
    <FasTagPaymentForm />
      <OperatorSelectionFasTag onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
