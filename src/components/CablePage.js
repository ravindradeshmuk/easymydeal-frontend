...
import CableRechargeForm from './CableRechargeForm';
import OperatorSelectionCable from './OperatorSelectionCable';
// ... Your icon imports
const services = [
...
const CablePage= () => {
  ...
  return (
    <div>
      ...
      <CableRechargeForm/>
      <OperatorSelectionCable onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
