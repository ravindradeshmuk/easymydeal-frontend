...
import SocietyRechargeForm from './SocietyRechargeForm';
import OperatorSelectionSociety from './OperatorSelectionSociety';
// ... Your icon imports
const services = [
...
const SocietyPage= () => {
  ...
  return (
    <div>
      ...
      <SocietyRechargeForm  />
      <OperatorSelectionSociety onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
