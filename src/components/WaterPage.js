...
import WaterPaymentForm from './WaterPaymentForm.js';
import OperatorSelectionWater from './OperatorSelectionWater.js';
import {
  Grid,
  IconButton,
  Typography,
...
const RechargeBillPay= () => {
  ...
  return (
    ...
    <WaterPaymentForm />
      <OperatorSelectionWater onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
