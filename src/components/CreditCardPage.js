...
import CreaditeRechargeForm from './CreaditeRechargeForm';
import OperatorSelectionCredit from './OperatorSelectionCredit ';
...
const CreditCardPage = () => {
  ...
  return (
    <div>
      ...
      <CreaditeRechargeForm/>
      <OperatorSelectionCredit onOperatorSelect={(path) => navigate(path)} />
    </div>
  );
};
