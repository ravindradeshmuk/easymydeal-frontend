...
import ElectricityBillPaymentForm from './ElectricityBillPaymentForm.js';
import OperatorSelectionElectricity from './OperatorSelectionElectricity.js';
// ... Your icon imports
const services = [
...
const RechargeBillPay= () => {
  ...
  return (
    ...
    <ElectricityBillPaymentForm/>
      <OperatorSelectionElectricity onOperatorSelect={(path) => navigate(path)}/>
    </div>
  );
};
